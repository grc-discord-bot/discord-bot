...
def get_response(message: str) -> str:
    ...
    if process_msg == '$help':
        return "`You can type in the commands below in the channel #bot-commands to interact with Mardo: 1. $help -> " \
               "which will make this current message appear` 2. hello -> which will give you a welcome message 3. ? " \
